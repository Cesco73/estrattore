...
# funzione per ESTRAI (la prima che viene chiamata all'atto dell'estrazione del giovatore)
def pesca (etichetta):
	global pescato
	if len(giocatori) == 0:
...
buttonEst.topleft = (855,10)
buttonEst.connect_signal (SIG_CLICKED, pesca, testo )
buttonEst.minsize = (65, 20)
buttonEst.set_depth(1)
buttonEst.color = (249,247,57)

buttonRej = Button ("#Invenduto")
buttonRej.topleft = (925,10)
